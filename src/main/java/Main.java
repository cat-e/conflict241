public class Main {
    public static void main(String[] args) {
        ...
        public int averageMonthlySales(sales){
            int sum = 0;
            for (int monthSale : sales) {
                sum += monthSale;
            }
        ...
        public int maxMonthSales(sales) {
        ...
        public int minMonthSales(sales) {
        ...
        public int monthsAmountWithSalesLowerAverage(sales) {
            int monthsAmount = 1;
        ...
        public int monthsAmountWithSalesHigherAverage(sales) {
            int monthsAmount = 1;
            int sum = 0; // мб не верно
            for (int monthSale : sales) {
                sum += monthSale;
